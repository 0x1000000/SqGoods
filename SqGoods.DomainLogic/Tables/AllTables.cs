...
namespace SqGoods.DomainLogic.Tables
{
    ...
    {
        public static TableBase[] BuildAllTableList() => new TableBase[]{GetAttribute(Alias.Empty), GetCategory(Alias.Empty), GetAttributeSet(Alias.Empty), GetProduct(Alias.Empty), GetCategoryAttribute(Alias.Empty), GetProductAttribute(Alias.Empty), GetProductAttributeSet(Alias.Empty)};
